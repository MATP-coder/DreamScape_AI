    ...
    <header className="w-full border-b dark:border-gray-700 bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center py-4 gap-4">
        ...
        <div className="flex items-center gap-3">
          {/*
            Um das Logo harmonisch in das farbige Kreiselement zu integrieren, verwenden wir
            keinen farbigen Hintergrund mehr, sondern einen transparenten Kreis mit
            Rand in der Markenfarbe. Der Logo‑Container erhält eine dezente Umrahmung,
            sodass das Logo auf jedem Hintergrund wirkt, ohne dass ein grauer Rand zu sehen ist.
          */}
          <span className="inline-flex items-center justify-center h-10 w-10 rounded-full border-2 border-brand dark:border-brand-light bg-transparent">
            <Image src="/logo.png" alt="DreamScape Logo" width={32} height={32} className="rounded-full" />
          </span>
