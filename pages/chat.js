...
export default function Chat() {
  ...
  // Vordefinierte Fragen für die Traumreise (als Fallback für Free‑Nutzer)
  const questions = [
  ...
  async function handleSend(e) {
    ...
    // Wenn noch weitere Fragen erlaubt sind, frage nach
    if (userCount < maxQuestions) {
      if (isPremium) {
        ...
        // Free: vordefinierte Fragen
        if (userCount < questions.length) {
          setMessages([...newMessages, { role: 'assistant', content: questions[userCount] }])
        } else {
